// import ThreeJS and any necessary extensions
...
const dat = await import('dat.gui/build/dat.gui.js');
const guiJson = (await import('./gui.json')).default
console.log(guiJson);
const gui = new dat.GUI({ load: guiJson, preset: 'Sleek' });
console.log(THREE.Curve);
// Grab some nice color palettes
const palettes = (await import('nice-color-palettes')).default;

//  glslify is used for including GLSL shader code
const glslify = (await import('glslify')).default;
